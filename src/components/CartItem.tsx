...
import { removeItem, addCartItem, minusItem, CartItem } from '../redux/slices/cartSlice';
...
const CartItemBlock: FC<CartItemProps> = ( {title, imageUrl, price, size, type, id, count} ) => {
